...
const MRD = () => {
    ...
    return (
        <div style={{
            /* Pull back the parent's padding on all sides */
            margin: '-2.5rem -4rem -5rem',
            /* Fill exactly the remaining height after the .header (which has margin-bottom:3rem + its own height ~60px) */
            ...
            {/* ── TOP BAR ── */}
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '0 24px', height: 56, background: '#fff', borderBottom: '1px solid #e5e7eb', flexShrink: 0 }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                    ...
                    <span style={{ fontWeight: 800, fontSize: 15, color: '#111827' }}>Medical Records</span>
                </div>
                <div style={{ display: 'flex', gap: 8 }}>
                    <button onClick={doExport} disabled={!patient || exporting} style={{ display: 'flex', alignItems: 'center', gap: 6, padding: '7px 16px', border: '1px solid #d1d5db', borderRadius: 8, background: '#fff', fontWeight: 700, fontSize: 13, color: '#374151', cursor: patient ? 'pointer' : 'not-allowed', opacity: patient ? 1 : 0.5 }}>
                        <Download size={14} /> Export
                    </button>
                    <button onClick={() => window.print()} style={{ display: 'flex', alignItems: 'center', gap: 6, padding: '7px 16px', border: '1px solid #d1d5db', borderRadius: 8, background: '#fff', fontWeight: 700, fontSize: 13, color: '#374151', cursor: 'pointer' }}>
